      ...
      <div className="UP">
        ...
        <div className="AddyandProject">
          <div className="ADDY">
            ...
            <div className="ADDYR">
            <InsertDriveFileOutlinedIcon fontSize="smaller"/>
            <FolderOpenOutlinedIcon fontSize="smaller"/>
            <ReplayOutlinedIcon fontSize="smaller"/>
            <BackupTableOutlinedIcon fontSize="smaller"/>
            </div>
          </div>
          <div className="menu">
          <div className="jaja" onClick={handle0}>
            ...
            <h5> AboutMe.html</h5>
            </div><div className="jaja" onClick={handle1}>
            <ArrowForwardIosIcon fontSize="smaller" />
            <svg
              width="16px"
              height="16px"
            ...
            <h5>Projects.css</h5>
            </div><div className="jaja" onClick={handle2}>
            <ArrowForwardIosIcon fontSize="smaller" />
            <svg
              width="15px"
              height="15px"
            ...
            <h5> Skills.js</h5>
            </div><div className="jaja" onClick={handle3}>
            <ArrowForwardIosIcon fontSize="smaller" />
            <svg
              width="15px"
              height="15px"
